 ...
 * by this service expire after 30 minutes per SCRUM-67 security requirement
 * (previously 45 minutes under SCRUM-3).</p>
 */
@Service
...
public class AuthService {
     ...
     * 30 minutes) and refresh token are generated and returned.</p>
     *
     * @param request the login request containing the user's email and password
     * @return a {@link LoginResponse} containing the access token, refresh token,
     *         token type, and expiration duration in seconds
     ...
     * The new access token expires after 30 minutes per SCRUM-67.</p>
     *

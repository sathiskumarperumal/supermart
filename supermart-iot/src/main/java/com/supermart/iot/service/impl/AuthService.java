 ...
 * by this service expire after 30 minutes per SCRUM-65 security requirement
 * (previously 45 minutes per SCRUM-3).</p>
 */
@Service
...
public class AuthService {
     ...
     * The new access token expires after 30 minutes per SCRUM-65.</p>
     *

 ...
 * recommendations (SCRUM-66; previously 45 minutes under SCRUM-3).</p>
 */
@Service
@Slf4j
public class JwtService {
     ...
     * Configured to 1800000 ms (30 minutes) per SCRUM-66 security requirement
     * (reduced from 2700000 ms / 45 minutes under SCRUM-3).
     */
